...
void D3DApp::init()
{
    ...
    LoadBitmapFromFile(
        TEXT("brick.jpg"), bmp_width, bmp_height, &bmp_bits
    );
...
std::pair<Vertex*, size_t> D3DApp::getHouseVertices() {
    static Vertex data[] = {
        ...
        {10.00000f, 0.00000f, 20.00000f, 10.00000f, 0.00000f, -0.00000f, 1.0f, 1.0f, 1.0f, 1.f, 1.0f, 1.0f},
        {10.00000f, 0.00000f, 10.00000f, 10.00000f, 0.00000f, -0.00000f, 1.0f, 1.0f, 1.0f, 1.f, 0.0f, 1.0f},
        ...
        {0.00000f, 0.00000f, 10.00000f, -0.00000f, 0.00000f, -10.00000f, 1.0f, 1.0f, 1.0f, 1.f, 0.0f, 1.0f},
        {0.00000f, 10.00000f, 10.00000f, -0.00000f, 0.00000f, -10.00000f, 1.0f, 1.0f, 1.0f, 1.f, 0.0f, 0.0f},
        {10.00000f, 0.00000f, 10.00000f, -0.00000f, 0.00000f, -10.00000f, 1.0f, 1.0f, 1.0f, 1.f, 1.0f, 1.0f},
        ...
        {0.00000f, 0.00000f, 10.00000f, -10.00000f, 0.00000f, 0.00000f, 1.0f, 1.0f, 1.0f, 1.f, 1.0f, 1.0f},
        {0.00000f, 0.00000f, 20.00000f, -10.00000f, 0.00000f, 0.00000f, 1.0f, 1.0f, 1.0f, 1.f, 0.0f, 1.0f},
        ...
        {0.00000f, 10.00000f, 10.00000f, 10.00000f, 0.00000f, 0.00000f, 1.0f, 1.0f, 1.0f, 1.f},
        //
        {10.00000f, 0.00000f, 20.00000f, 0.00000f, 0.00000f, 10.00000f, 1.0f, 1.0f, 1.0f, 1.f, 0.0f, 1.0f},
        {10.00000f, 10.00000f, 20.00000f, 0.00000f, 0.00000f, 10.00000f, 1.0f, 1.0f, 1.0f, 1.f, 0.0f, 0.0f},
        {0.00000f, 0.00000f, 20.00000f, 0.00000f, 0.00000f, 10.00000f, 1.0f, 1.0f, 1.0f, 1.f, 1.0f, 1.0f},
